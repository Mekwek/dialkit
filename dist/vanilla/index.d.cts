...
declare function createDialKit<T extends DialConfig>(name: string, config: T, options?: CreateDialOptions): DialKitController<T>;
declare const createDialKitController: typeof createDialKit;
...
declare function createDialRoot(options?: DialRootOptions): {
    element: HTMLDivElement;
    destroy(): void;
};
declare const DialRoot: typeof createDialRoot;
...
interface DialTimelineOptions$1 {
    id?: string;
    persist?: DialKitPersistOptions;
...
type CreateDialTimelineOptions = DialTimelineOptions$1;
interface DialTimelineController<T extends TimelineConfig> {
    readonly id: string;
...
declare function createDialTimeline<T extends TimelineConfig>(name: string, config: T, options?: CreateDialTimelineOptions): DialTimelineController<T>;
...
declare function mountSpringVisualization(host: HTMLElement, initial: SpringVisualizationProps): Mounted<SpringVisualizationProps>;
...
declare function mountTransitionControl(host: HTMLElement, initial: TransitionControlProps, springOnly?: boolean): Mounted<TransitionControlProps>;
...
declare function mountSpringControl(host: HTMLElement, props: SpringControlProps): Mounted<SpringControlProps>;
...
declare function mountControlRenderer(host: HTMLElement, initial: ControlRendererProps): Mounted<ControlRendererProps>;
...
declare function mountFolder(host: HTMLElement, initial: FolderProps): {
    element: HTMLDivElement;
    body: HTMLDivElement;
    toolbar: HTMLDivElement;
    update(next: FolderProps): void;
    destroy(): void;
};
...
declare function mountSegmentedControl<T extends string>(host: HTMLElement, initial: SegmentedControlProps<T>): Mounted<SegmentedControlProps<T>>;
...
declare function mountToggle(host: HTMLElement, initial: ToggleProps): Mounted<ToggleProps>;
...
declare function mountSlider(host: HTMLElement, initial: SliderProps): Mounted<SliderProps>;
...
declare function mountTextControl(host: HTMLElement, initial: TextControlProps): Mounted<TextControlProps>;
...
declare function mountButtonGroup(host: HTMLElement, initial: ButtonGroupProps): Mounted<ButtonGroupProps>;
...
declare function mountSelectControl(host: HTMLElement, initial: SelectControlProps): Mounted<SelectControlProps>;
...
declare function mountPresetManager(host: HTMLElement, initial: PresetManagerProps): Mounted<PresetManagerProps>;
declare function mountShortcutsMenu(host: HTMLElement, initial: {
    panelId: string;
}): Mounted<{
    panelId: string;
}>;
...
declare function mountImageControl(host: HTMLElement, initial: ImageControlProps, presentation?: 'popover' | 'inline'): {
    update(next: ImageControlProps): void;
    destroy(): void;
};
...
declare function mountEasingVisualization(host: HTMLElement, initial: EasingVisualizationProps): {
    update(next: EasingVisualizationProps): void;
    destroy(): void;
};

/** Roots share one listener, so mounting two editing surfaces never doubles a shortcut. */
declare function mountShortcutListener(): {
    destroy(): void;
};
...
type DialTimelineProps = DialTimelineOptions;
/** Mount the timeline dock independently of the parameter panel. */
declare function createDialTimelineRoot(initial?: DialTimelineOptions): {
    element: HTMLDivElement;
    setVisible(visible: boolean): void;
    update(next: Pick<DialTimelineOptions, "theme" | "visible" | "onVisibilityChange">): void;
    destroy(): void;
};
declare const DialTimeline: typeof createDialTimelineRoot;

export { type ActionConfig, mountButtonGroup as ButtonGroup, type ButtonGroupProps, type ColorConfig, mountColorControl as ColorControl, type ColorControlProps, type ControlMeta, mountControlRenderer as ControlRenderer, type ControlRendererProps, type CreateDialOptions, type CreateDialTimelineOptions, type DialConfig, type DialKitController, type DialKitPersistOptions, type DialKitValueUpdates, type DialMode, mountDialPad as DialPad, type DialPadAxis, type DialPadConfig, type DialPadProps, type DialPadValue, type DialPosition, DialRoot, type DialRootOptions, DialStore, type DialTheme, DialTimeline, type DialTimelineController, type DialTimelineOptions, type DialTimelineProps, type DialTimelineValues, type DialValue, type EasingConfig, mountEasingVisualization as EasingVisualization, type EasingVisualizationProps, mountFolder as Folder, type FolderProps, type ImageConfig, mountImageControl as ImageControl, type ImageControlProps, type ImageOption, type PanelConfig, type Preset, mountPresetManager as PresetManager, type PresetManagerProps, type ResolvedValues, mountSegmentedControl as SegmentedControl, type SegmentedControlProps, type SelectConfig, mountSelectControl as SelectControl, type SelectControlProps, type ShortcutConfig, type ShortcutInteraction, type ShortcutMode, mountShortcutsMenu as ShortcutsMenu, mountSlider as Slider, type SliderProps, type SpringConfig, mountSpringControl as SpringControl, type SpringControlProps, mountSpringVisualization as SpringVisualization, type SpringVisualizationProps, type TextConfig, mountTextControl as TextControl, type TextControlProps, type TimelineClipConfig, type TimelineClipCss, type TimelineClipLoop, type TimelineClipMeta, type TimelineClipTrackMeta, type TimelineClipValues, type TimelineConfig, type TimelineGroupConfig, type TimelineGroupValues, type TimelineMeta, type TimelinePropConfig, type TimelinePropStepConfig, type TimelineStepConfig, type TimelineStepValues, TimelineStore, type TimelineTransport, mountToggle as Toggle, type ToggleProps, type TransitionConfig, mountTransitionControl as TransitionControl, type TransitionControlProps, createDialKit, createDialKitController, createDialRoot, createDialTimeline, createDialTimelineRoot, formatClock, mountButtonGroup, mountColorControl, mountControlRenderer, mountDialPad, mountEasingVisualization, mountFolder, mountImageControl, mountPresetManager, mountSegmentedControl, mountSelectControl, mountShortcutListener, mountShortcutsMenu, mountSlider, mountSpringControl, mountSpringVisualization, mountTextControl, mountToggle, mountTransitionControl };
