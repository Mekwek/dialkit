...
.dialkit-timeline-section[data-single-track] {
  ...
  --dial-timeline-bar-rest: #b9b9b9;
  --dial-timeline-bar-played: #ffffff;
  --dial-timeline-bar-text: rgba(0, 0, 0, 0.78);
  --dial-timeline-tail-border: rgba(255, 255, 255, 0.75);
...
.dialkit-root[data-theme="light"] .dialkit-timeline-section[data-single-track] {
  --dial-timeline-bar-rest: #9e9e9e;
  --dial-timeline-tail-border: rgba(0, 0, 0, 0.55);
...
/* Hover and selected rings around the bar, in the accent red. */
.dialkit-timeline-section[data-single-track] .dialkit-timeline-clip:hover {
  box-shadow: 0 0 0 1.5px color-mix(in srgb, var(--dial-timeline-accent) 55%, transparent);
}

.dialkit-timeline-section[data-single-track] .dialkit-timeline-clip[data-selected] {
  box-shadow: 0 0 0 2px var(--dial-timeline-accent);
}
...
/* Resize grips: visible affordances on hover, one per edge. */
...
.dialkit-timeline-section[data-single-track] .dialkit-timeline-clip:hover .dialkit-timeline-clip-handle::after {
  opacity: 1;
}
