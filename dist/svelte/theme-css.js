...
.dialkit-color-fields { display: flex; align-items: center; gap: 8px; height: var(--dial-row-height); padding: 0 8px 0 6px; border-radius: var(--dial-radius); background: var(--dial-surface); font: 500 12px 'Geist Mono', monospace; color: var(--dial-text-label); }
.dialkit-color-channels { display: flex; flex: 1; min-width: 0; align-items: center; gap: 6px; }
...
.dialkit-color-eyedropper { display: flex; flex-shrink: 0; align-items: center; justify-content: center; width: 22px; height: 22px; padding: 0; border: 0; border-radius: 4px; background: var(--dial-surface-hover); color: var(--dial-text-label); cursor: pointer; transition: background 0.15s, color 0.15s; }
.dialkit-color-eyedropper:hover { background: var(--dial-surface-active); color: var(--dial-text-focus); }
